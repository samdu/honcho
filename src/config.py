...
class DeriverSettings(HonchoSettings):
    ...
    # Cosine distance threshold below which a new observation is treated as
    # a duplicate of an existing one. Tighter values (0.05) only catch
    # near-identical wording; looser values (0.20+) catch genuine paraphrases
    # at some risk of conflating distinct events that share infrastructure.
